<section id="contact" class="py-5">
    <div class="container py-5">
        <div class="text-center mb-5" data-aos="fade-up">
            <h2 class="fw-bold section-title">Kontak Saya</h2>
            <div class="divider mx-auto bg-primary"></div>
            <p class="text-muted mt-3">Mari berkolaborasi dan wujudkan ide Anda menjadi nyata.</p>
        </div>
        
        <div class="row justify-content-center">
            <div class="col-lg-8" data-aos="zoom-in">
                <div class="card border-0 shadow-sm rounded-4 glass-card p-2 p-md-4">
                    <div class="card-body">
                        <div class="row gy-4 text-center">
                            ...
                            <div class="col-6 col-md-3">
                                <a href="mailto:bernardsubur@gmail.com" class="text-decoration-none text-body contact-link">
                                    ...
                                    <span class="small text-muted d-block text-truncate">Kirim Pesan</span>
                                </a>
                            </div>
                            <!-- LinkedIn -->
                            <div class="col-6 col-md-3">
                                <a href="https://www.linkedin.com/in/yosef-bernardus-janson-subur/" target="_blank" class="text-decoration-none text-body contact-link">
                                    ...
                                    <span class="small text-muted d-block text-truncate">Terhubung</span>
                                </a>
                            </div>
                            <!-- GitHub -->
                            <div class="col-6 col-md-3">
                                <a href="https://github.com/BernardSubur" target="_blank" class="text-decoration-none text-body contact-link">
                                    ...
                                    <span class="small text-muted d-block text-truncate">Lihat Kode</span>
                                </a>
                            </div>
                            <!-- WhatsApp -->
                            <div class="col-6 col-md-3">
                                <a href="https://wa.me/NOMOR_WA_ANDA" target="_blank" class="text-decoration-none text-body contact-link">
                                    ...
                                    <span class="small text-muted d-block text-truncate">Chat Langsung</span>
                                </a>
                            </div>
                        </div>
